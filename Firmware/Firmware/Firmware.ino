...
void loop() 
{
    ...
    if(menuOption == '1')
    {
    // Disclaimer: The SparkFun BME280 - Atmospheric Sensor Breakout is in testing and/or doesn't have code, therefore it may be buggy. Please be kind and report any bugs you may find.
    }
...
char menu()
{
    ...
    Serial.println(F("(1) SparkFun BME280 - Atmospheric Sensor Breakout"));
    ...
    while (Serial.available()) 
    {
        ...
        {   
            ...
            if(c == '1') 
    			Serial.println(F("Now Testing SparkFun BME280 - Atmospheric Sensor Breakout - note that this component doesn't have a test code"));
    		else if(c == '2') 
